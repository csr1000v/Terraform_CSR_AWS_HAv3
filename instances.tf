module instance1 {
  ...
  #iam_instance_profile = "${aws_iam_instance_profile.csr1000v[0].name}"
  iam_instance_profile        = "${var.csr1000v_instance_profile != null ? var.csr1000v_instance_profile : aws_iam_instance_profile.csr1000v[0].name}"
